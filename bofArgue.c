...
int go(char * args, int alen)
{
	...
	// Start process suspended in the System32 target space
	...
	//Write RealArguments to process memory
	...
	//Write cmdBuffer length to the process memory
